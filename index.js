...
function cadastrarReceita(id, receita, dificuldade, ingredientes, instrucoes,link, vegana) {
    receitasDaOmma.push({
      id,
      receita,
      dificuldade,
...
//função responsavel pela exibição e diferenciar arquivos veganos de não veganos//
  function exibirReceitas() {
    receitasDaOmma.forEach(receita => {
      ...
      console.log('Instruções: ' + receita.link);
      if (receita.vegana) {
  ...
  function deletarReceitas(id) {
    ...
    } else {console.log(`Receita com id ${id} não encontrada.`);
    }
  }
  //receitas que foram cadastradas//
cadastrarReceita(
  1, 
  'Bobó de camarão', 
  'Difícil', 
  ...
  'https://www.youtube.com/watch?v=UITsK_S3I_Y',
  true
);
cadastrarReceita(
  2,
...
cadastrarReceita(
  ...
  'https://www.youtube.com/watch?v=QawfgzmQHgY',
  false);
cadastrarReceita(
    4,
 'Ratatouille',
...
'https://www.youtube.com/watch?v=dlb3zIYF5yE',
true);
...
'https://www.youtube.com/watch?v=zvKybxhcO1g',
true);
cadastrarReceita(6,
 'Torta de frango',
 'média',
...
'https://www.youtube.com/watch?v=FtsdB5A64i0',
false);
console.log(receitasDaOmma)
exibirReceitas()//codigo para exibição das receitas// 
deletarReceitas(5);//codigo para deletar receitas pelo seu id//
